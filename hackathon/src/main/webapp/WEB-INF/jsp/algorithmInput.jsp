		...
		if(obj.checked)
		{
			 ...
			 if (!newTR.length)
			 {
				 var newTR= "<tr id=\"" + checkedValue +"\"><td width=\"35%\">" + checkedValue + "</td><td width=\"35%\"><input type=\"radio\" name=\"selectedTypes[" + 
				     checkedValue + "]\" value=\"String\"/>String <input type=\"radio\"  name=\"selectedTypes[" + 
				     checkedValue + "]\" value=\"Number\"/>Number</td><td width=\"15%\"><input type=\"text\" name=\"defaultValues["+ 
		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="#">Trigger Model</a></li>
...
<form:form	action="/test" method="POST"  modelAttribute="form">
	<div class="container">
		...
		<div class="starter-template">
				<h1>Trigger Model Entry</h1>
			<label>Trigger Name: </label>	<form:input type="text" path="algorithmData.algorithmName" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Language: <form:radiobutton  path="algorithmData.language" value="JavaScript"/>Java Script &nbsp;&nbsp;&nbsp;&nbsp;
						<form:radiobutton  path="algorithmData.language" value="R" />R</label> 
			<hr>
			<label>Function Definition: </label>
				<br>
				<form:textarea path="algorithmData.algorithmFunction"  rows="10" cols="100" ></form:textarea>
				
				<table width="100%">
				<thead><tr><td width="35%"><label>Parameter Name</label> </td>
					<td width="35%" ><label>Data Type</label></td>
					<td width="15%"><label>Default Value</label></td>
					<td width="15%" ><label>Test Value</label></td>
					</tr></thead>
				<tbody id="parameters">
				...
				<tr id="${selected}"><td width="35%"><c:out value="${selected}"/></td>
					<%-- 	<td width="35%"><input type="radio" name="selectedTypes[${selected}]" value="String"/>String 
						...
						<td width="35%"><form:radiobutton  path="selectedTypes['${selected}']" value="String"/>String 
						<form:radiobutton  path="selectedTypes['${selected}']" value="Number" />Number</td>

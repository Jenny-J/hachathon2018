...
<form:form	action="/run/retrievetrigger" method="POST"  modelAttribute="form">
	<div class="container">
	<h1>Run Trigger </h1>
		...
		<div class="starter-template">
				 ...
				 <label>Trigger Name:  <c:out value="${form.selectedAlg.algorithmName}"/> </label> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  
